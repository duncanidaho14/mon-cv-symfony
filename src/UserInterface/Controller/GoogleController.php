...
class GoogleController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        // if user fails to login, render the login form with error
        if ($error) {
    ...
    {
        return static::authenticate($request);
    }
    ...
    protected function getResourceOwnerFromCredentials(AccessToken $credentials): UserInterface
    {
        ...
        return static::getResourceOwnerFromCredentials($credentials);
    }
    ...
    //             'redirectUri'  => 'http://localhost:8000', // or the exact URL declared in Google
    //             'hostedDomain' => 'http://localhost:8000', // optional; used to restrict access to users on your G Suite/Google Apps for Business accounts
    //         ]);
    ...
    //     return new RedirectResponse($this->router->generate('cv_analytics'));
    // }
}
